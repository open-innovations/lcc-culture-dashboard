/*
	...
	Adapted OI Lume Viz Dashboard Interactivity
 
	<span class="bignum" data="37" data-prefix="£" data-postfix="p" data-precision="1" data-compact-format="true">£37p</span>
...
(function(root){
	...
	function Animatable(){
		...
		// Find all the .bignum classes on the page

		var bignums = document.querySelectorAll(".bignum");
		...
		var monitor = new InView(bignums);
	...
	root.OI.Animatable = Animatable;
 
})(window || this);
 
OI.ready(function(){ OI.Animatable(); });
